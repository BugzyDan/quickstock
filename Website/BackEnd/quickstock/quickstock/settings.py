...
QUICKSTOCK_SEND_LEGACY_VERIFICATION_EMAILS = _env_bool(
    "QUICKSTOCK_SEND_LEGACY_VERIFICATION_EMAILS",
    False,
)
...
QUICKSTOCK_SUPERUSER_USERNAME = _env_str("QUICKSTOCK_SUPERUSER_USERNAME")
QUICKSTOCK_ALLOW_SUPERUSER_OTP_BYPASS = _env_bool("QUICKSTOCK_ALLOW_SUPERUSER_OTP_BYPASS", False)
