...
os.environ.setdefault("DJANGO_SECRET_KEY", "deploy-check-secret-key-that-is-long-and-random-1234567890")
os.environ.setdefault("DJANGO_DEBUG", "false")
os.environ.setdefault("DJANGO_ALLOWED_HOSTS", "deploy-check.local")
os.environ.setdefault("DJANGO_CSRF_TRUSTED_ORIGINS", "https://deploy-check.local")
